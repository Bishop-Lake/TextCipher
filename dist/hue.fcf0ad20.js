...
},{}],"src/hue.js":[function(require,module,exports) {
"use strict";
...
function drawCharacter(letter) {
  ...
  var cellFour = document.createElement("div");
  var cellFive = document.createElement("div");
  var cellSix = document.createElement("div");
  var charKey = document.createElement("p");
...
document.querySelector(".translate").addEventListener("click", renderTranslation);
...
function renderTranslation() {
  ...
  var stringToTranslate = document.querySelector(".text-to-translate").value.toLowerCase().trim("  ").split("");
  stringToTranslate.forEach(function (char) {
    return drawCharacter(char);
  });
...
document.querySelector(".create-image").addEventListener("click", function () {
  var preImg = document.querySelector(".character-container");
  document.querySelector(".new-image").innerHTML = "";

  _domToImage.default.toPng(preImg).then(function (dataUrl) {
    var img = new Image();
    img.src = dataUrl;
...
},{"dom-to-image":"node_modules/dom-to-image/src/dom-to-image.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/hue.js"], null)
//# sourceMappingURL=/hue.fcf0ad20.js.map